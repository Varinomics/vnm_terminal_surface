...
function(run_package_step description)
...
run_package_step("LCD provider configure"
    ${configure_args}
...
run_package_step("LCD provider build"
    --build "${package_root}/lcd-build" --config "${install_config}" --parallel 1)
run_package_step("LCD provider install"
    --install "${package_root}/lcd-build" --config "${install_config}")
...
run_package_step("Package producer configure"
    ${configure_args} -C "${package_context}"
...
run_package_step("Package producer build"
    --build "${package_binary_dir}" --config "${install_config}" --parallel 1)
