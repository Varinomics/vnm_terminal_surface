...
file(GLOB_RECURSE provider_config_paths
    ...
    "${mismatch_install_dir}/vnm_qt_dispatchConfig.cmake")
...
if(NOT provider_config_count EQUAL 1)
    message(FATAL_ERROR
        ...
        "${provider_config_count} under ${mismatch_install_dir}")
endif()
...
if(NOT provider_cache_entry_count EQUAL 1)
    message(FATAL_ERROR
        "Negative package smoke cache does not contain exactly one "
...
if(NOT resolved_provider_dir STREQUAL provider_package_dir)
    message(FATAL_ERROR
        "Negative package smoke resolved vnm_qt_dispatch outside the staged "
        "prefix:\n"
