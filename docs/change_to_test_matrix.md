...
| Row images in snapshots and frames (snapshot image field, image check, image quads, projection rows, canvas export text only) | `vnm_terminal_render_snapshot`, `vnm_terminal_render_frame`, `vnm_terminal_backend_session`, `vnm_terminal_canvas_export`, `vnm_terminal_sixel_placement` | surface |
